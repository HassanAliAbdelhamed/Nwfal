...
import { Mail, Phone, MapPin, Clock, Send, User, MessageSquare, Youtube, Settings, Wrench, Target, Box, Layers } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 text-gray-900 overflow-x-hidden">
      ...
      <section className="relative z-10 py-20 px-4">
        <div className="max-w-7xl mx-auto">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4 p-6 bg-white/90 backdrop-blur-sm rounded-3xl border-2 border-red-200 hover:border-red-300 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:-translate-y-1">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">support@entreprise.fr</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4 p-6 bg-white/90 backdrop-blur-sm rounded-3xl border-2 border-red-200 hover:border-red-300 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:-translate-y-1">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">+33 1 23 45 67 90</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4 p-6 bg-white/90 backdrop-blur-sm rounded-3xl border-2 border-red-200 hover:border-red-300 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:-translate-y-1">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 mb-2 text-lg">Horaires d'Ouverture</h3>
          ...
          <div className="mt-16 bg-red-600 rounded-3xl p-8 text-white shadow-2xl">
            <div className="text-center">
              <h3 className="text-3xl md:text-4xl font-bold mb-4">
                Besoin d'une <span className="text-white">Assistance</span> Immédiate ?
              </h3>
              <p className="text-lg md:text-xl opacity-90 mb-8 max-w-3xl mx-auto leading-relaxed">
                Pour les urgences ou les questions nécessitant une réponse rapide, 
                n'hésitez pas à nous appeler directement.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
                <a
                  href="tel:+15551234567"
                  className="bg-white text-red-600 px-8 py-4 rounded-2xl font-bold hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 flex items-center space-x-3 shadow-xl"
                >
                  <Phone className="h-5 w-5" />
                  <span>Appelez Maintenant</span>
                </a>
                <a
                  href="mailto:nawfal.bouy.1@gmail.com"
                  className="border-2 border-white text-white px-8 py-4 rounded-2xl font-bold hover:bg-white hover:text-red-600 transition-all duration-300 transform hover:scale-105 flex items-center space-x-3"
                >
